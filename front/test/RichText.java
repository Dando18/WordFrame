...
public class RichText extends VBox {
    ...
    public RichText () {
        ...
        Node[] buttons = {undoBtn, redoBtn, cutBtn, copyBtn, pasteBtn, boldBtn, italicBtn,
        		underlineBtn, strikeBtn, insertImageBtn, alignLeftBtn, alignCenterBtn,
        		alignRightBtn, alignJustifyBtn};
        ...
        panel1.getChildren().addAll(
                ...
                wrapToggle, undoBtn, redoBtn, 
                new Separator(Orientation.VERTICAL),
                boldBtn, italicBtn, underlineBtn, strikeBtn,
                new Separator(Orientation.VERTICAL),
                alignLeftBtn, alignCenterBtn, alignRightBtn, alignJustifyBtn, insertImageBtn,
                sizeCombo, familyCombo, textColorPicker, backgroundColorPicker, paragraphBackgroundPicker);
